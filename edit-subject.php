...
$sql="update  tblsubjects set SubjectName=:subjectname,SubjectTeacher=:subjectteacher where id=:sid";
$query = $dbh->prepare($sql);
$query->bindParam(':subjectname',$subjectname,PDO::PARAM_STR);
$query->bindParam(':subjectteacher',$subjectteacher,PDO::PARAM_STR);
...
<div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Subject Teacher</label>
                                                        <div class="col-sm-10">
 <input type="text" name="subjectteacher" class="form-control" value="<?php echo htmlentities($result->SubjectTeacher);?>"  id="default" placeholder="Subject Teacher" required="required">
                                                        </div>
                                                    </div>
                                                    <?php }} ?>
